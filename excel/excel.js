...
class ExcelMaker {
    ...
    constructor(innerUploadUrl) {
        ...
        this.cnCacheSimple = {};
        this.keyInt = ['id', 'pid', 'price', 'type', 'sub_type', 'pose_ids', 'ancient', 'modern', 'east', 'west', 'toy_sub_type', 'rare', 'intimacy', 'award', 'character', 'dispatch', 'cat_type', 'play_time', 'is_skin', 'sampleCatId', 'torso_offsetx', 'torso_offsety', 'is_multi', 'stock_price', 'bonus_price', 'sour', 'sweet', 'bitter', 'spicy', 'oa_unlock', 'effects_type', 'effects', 'learn_time', 'show_order', "scores", "level1", "level2", "level3"];
